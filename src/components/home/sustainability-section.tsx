  ...
  return (
    <section className="bg-white py-8 md:py-16">
      <div className="px-6 md:px-16 lg:px-32">
        {/* Heading */}
        <h2 className="text-lg md:text-xl lg:text-[26px] font-medium text-center text-gray-900 mb-4 md:mb-5.5">
          Sustainability & Environmental Impact
        </h2>

        {/* Description */}
        <p className="text-center text-sm md:text-sm lg:text-base leading-5 md:leading-6 lg:leading-4 mb-6 md:mb-8 lg:mb-5.5 max-w-4xl mx-auto">
        ...
        <div className="relative w-full rounded-[12px] md:rounded-[16px] lg:rounded-[20px] overflow-hidden shadow-lg">
          ...
          <button className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 
            bg-white text-gray-800 px-4 py-2 md:px-6 md:py-3 rounded-full text-sm md:text-base font-medium shadow-lg hover:bg-gray-50 transition-colors">
            Open Map
          </button>
        </div>
      </div>
